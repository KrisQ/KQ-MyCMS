             ...
             <div class="panel-footer">
                 ...
                 <div class="clearfix"></div>
                  ...
                  <?php 
                    ...
                    $published_post_counts = mysqli_num_rows($select_all_posts);
                
                    $query = "SELECT * FROM comments WHERE comment_status = 'unaproved'";
                    $select_all_unapprove_comments = mysqli_query($connection,$query);
                    $published_unapprove_counts = mysqli_num_rows($select_all_unapprove_comments);
                    
                    $query = "SELECT * FROM users WHERE user_role = 'subscriber'";
                    $select_all_subscriber = mysqli_query($connection,$query);
                    $published_subscriber_counts = mysqli_num_rows($select_all_subscriber);
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Date', 'Count'],
            ...
            $element_text = ['Published Posts', 'Draft Posts', 'Comments', 'Unapproved Comments', 'Users', 'Subscriber Users', 'Categories'];
            $element_count = [$published_post_counts, $draft_post_counts, $comment_counts, $published_unapprove_counts, $user_counts, $published_subscriber_counts, $categories_counts];
